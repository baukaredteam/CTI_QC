...
const mockHypotheses = [
  {
    ...
    confidence_priority_bonus: 0.25,
    related_threats: ['Kasablanka', 'Sandworm'],
    adversary_playbooks: ['Port Scan', 'C2 Beacon'],
    infrastructure_pivots: [
      { infra_ip: '203.0.113.7', port: 443, tags: ['c2'] },
      { nested: { inner: 'must-not-render' } },
    ],
    predicted_next_techniques: [
      { technique_id: 'T1132', name: 'Data Encoding', probability: 0.7, basis: 'attack_flow' },
      { technique_id: 'T1071', name: 'Application Layer Protocol', probability: 0.9, basis: 'canonical' },
      { technique_id: 'T1560', name: 'Archive Collected Data', probability: null, basis: 'attack_flow' },
    ],
  ...
  },
  {
    ...
    zone: 'high',
    status: 'rejected',
    coverage_status: 'FIELD_PARTIAL',
    coverage_status_ru: 'частично покрыто',
    covering_rule_ids: ['ag-rule-7'],
    admiralty: { letter: 'C', digit: '2', rationale_ru: 'C-2: гипотеза отклонена аналитиком.' },
    chokepoints: [],
    candidate_chokepoints: [],
    expected_evidence_ru: 'Частично покрыто правилом ag-rule-7 — требуется донастройка телеграфного поля.',
    text_ru: 'частично покрыто — Поведение T1059.001 частично покрыто правилом ag-rule-7.',
    threat_title: 'Kasablanka',
    threat_summary: 'Kasablanka; TTP: 4',
    actor: 'APT33',
    sectors: ['energy'],
    iocs: [],
    data_sources: [],
    confidence_priority_bonus: null,
    related_threats: ['Kasablanka'],
    adversary_playbooks: ['C2 Beacon'],
    infrastructure_pivots: [],
    predicted_next_techniques: [],
  ...
  {
    id: 'h-3',
    threat_id: 'TL-2026-1697',
    tenant_id: 'critical_infrastructure',
    technique_id: 'T1078',
    ...
    coverage_status_ru: 'покрыто',
    covering_rule_ids: ['ag-rule-11'],
    admiralty: { letter: 'B', digit: '4', rationale_ru: 'B-4: гипотеза отклонена аналитиком.' },
    chokepoints: [],
    candidate_chokepoints: [],
    expected_evidence_ru: 'Покрыто правилом ag-rule-11 — дополнительных свидетельств не требуется.',
    text_ru: 'покрыто — Поведение T1078 покрыто правилом ag-rule-11.',
    threat_title: 'Sandworm',
    threat_summary: 'Sandworm; TTP: 9',
    actor: '',
