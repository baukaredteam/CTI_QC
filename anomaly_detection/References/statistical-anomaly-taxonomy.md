...
The following examples show how statistical anomaly types can explain observable suspicious or malicious activity. These links lead to the [activity-to-anomaly mapping catalog](../docs-site/docs/attack-statistical-anomaly-mapping.md), where each activity is described in terms of its comparison unit, expected behavior, measurable deviation, ATT&CK technique, and evidence sources. Statistical deviation is supporting evidence, not proof of malicious intent.

| Statistical anomaly type | Linked suspicious or malicious activity examples |
|---|---|
| [Collective Anomaly](#4-collective-anomaly) | [Low-volume password failures distributed across many accounts](../docs-site/docs/attack-statistical-anomaly-mapping.md#password-spraying) |
| [Conditional Anomaly](#5-conditional-anomaly) | [Trusted system binary launches unexpected content](../docs-site/docs/attack-statistical-anomaly-mapping.md#trusted-binary-proxy-execution), [object renamed to resemble a trusted object](../docs-site/docs/attack-statistical-anomaly-mapping.md#masquerading), [protected credential resource accessed by an unusual process](../docs-site/docs/attack-statistical-anomaly-mapping.md#credential-dumping) |
| [Self-Baseline Anomaly](#7-self-baseline-anomaly) | [Valid credentials used from an unexpected context](../docs-site/docs/attack-statistical-anomaly-mapping.md#valid-account-abuse), [command interpreter execution outside a host or user's normal pattern](../docs-site/docs/attack-statistical-anomaly-mapping.md#command-interpreter-execution), [new autostart configuration](../docs-site/docs/attack-statistical-anomaly-mapping.md#autostart-change) |
| [Peer-Group Anomaly](#8-peer-group-anomaly) | [Unexpected container administration command](../docs-site/docs/attack-statistical-anomaly-mapping.md#container-exec), [privileged container unlike peer workloads](../docs-site/docs/attack-statistical-anomaly-mapping.md#privileged-container), [cloud-resource enumeration unlike role peers](../docs-site/docs/attack-statistical-anomaly-mapping.md#cloud-enumeration) |
| [Population Anomaly](#9-population-anomaly) | [Synchronized behavioral change after a compromised software installation](../docs-site/docs/attack-statistical-anomaly-mapping.md#supply-chain-installation) |
| [Count Anomaly](#13-count-anomaly) | [Unusually many public web paths requested in a session](../docs-site/docs/attack-statistical-anomaly-mapping.md#public-web-enumeration) |
| [Rate Anomaly](#14-rate-anomaly) | [External service scanning](../docs-site/docs/attack-statistical-anomaly-mapping.md#external-service-scanning), [password guessing](../docs-site/docs/attack-statistical-anomaly-mapping.md#password-guessing), [internal service scanning](../docs-site/docs/attack-statistical-anomaly-mapping.md#internal-service-scanning), [service disruption](../docs-site/docs/attack-statistical-anomaly-mapping.md#service-disruption) |
| [Volume Anomaly](#15-volume-anomaly) | [DNS enumeration](../docs-site/docs/attack-statistical-anomaly-mapping.md#dns-enumeration), [bulk data access](../docs-site/docs/attack-statistical-anomaly-mapping.md#bulk-data-access), [large outbound transfer](../docs-site/docs/attack-statistical-anomaly-mapping.md#large-outbound-transfer), [data destruction](../docs-site/docs/attack-statistical-anomaly-mapping.md#data-destruction) |
| [Burst Anomaly](#16-burst-anomaly) | [Repeated MFA prompts](../docs-site/docs/attack-statistical-anomaly-mapping.md#mfa-fatigue), [service-ticket request burst](../docs-site/docs/attack-statistical-anomaly-mapping.md#kerberoasting), [sudden secret retrieval](../docs-site/docs/attack-statistical-anomaly-mapping.md#secret-retrieval) |
| [Drought or Silence Anomaly](#17-drought-or-silence-anomaly) | [Indicator or telemetry removal](../docs-site/docs/attack-statistical-anomaly-mapping.md#indicator-removal), [security sensor or logging disabled](../docs-site/docs/attack-statistical-anomaly-mapping.md#tool-disablement) |
| [Duration Anomaly](#18-duration-anomaly) | [External remote-service session with unusual duration](../docs-site/docs/attack-statistical-anomaly-mapping.md#external-remote-session) |
| [Inter-Arrival-Time Anomaly](#19-inter-arrival-time-anomaly) | [Repeated MFA prompts](../docs-site/docs/attack-statistical-anomaly-mapping.md#mfa-fatigue), [periodic command-and-control communication](../docs-site/docs/attack-statistical-anomaly-mapping.md#periodic-c2) |
| [Ratio or Proportion Anomaly](#20-ratio-or-proportion-anomaly) | [Abnormal web response-code composition](../docs-site/docs/attack-statistical-anomaly-mapping.md#public-web-enumeration), [password-guessing failure ratio](../docs-site/docs/attack-statistical-anomaly-mapping.md#password-guessing), [MFA denial ratio](../docs-site/docs/attack-statistical-anomaly-mapping.md#mfa-fatigue) |
| [Temporal-Context Anomaly](#21-temporal-context-anomaly) | [Valid-account use at an unusual time](../docs-site/docs/attack-statistical-anomaly-mapping.md#valid-account-abuse), [external remote session outside normal hours](../docs-site/docs/attack-statistical-anomaly-mapping.md#external-remote-session), [unexpected serverless invocation](../docs-site/docs/attack-statistical-anomaly-mapping.md#serverless-execution) |
| [Level-Shift Anomaly](#23-level-shift-anomaly) | [Security telemetry drops to zero](../docs-site/docs/attack-statistical-anomaly-mapping.md#tool-disablement), [sustained bulk data access](../docs-site/docs/attack-statistical-anomaly-mapping.md#bulk-data-access), [resource hijacking](../docs-site/docs/attack-statistical-anomaly-mapping.md#resource-hijacking) |
| [Change-Point Anomaly](#25-change-point-anomaly) | [Startup or logon configuration abruptly changes](../docs-site/docs/attack-statistical-anomaly-mapping.md#autostart-change) |
| [Periodicity Anomaly](#27-periodicity-anomaly) | [Low-and-slow exfiltration](../docs-site/docs/attack-statistical-anomaly-mapping.md#low-and-slow-exfiltration), [periodic command-and-control communication](../docs-site/docs/attack-statistical-anomaly-mapping.md#periodic-c2) |
| [Phase Anomaly](#28-phase-anomaly) | [Scheduled execution occurs at a changed phase](../docs-site/docs/attack-statistical-anomaly-mapping.md#scheduled-execution) |
| [Subsequence Anomaly](#30-subsequence-anomaly) | [Unusual DNS command-and-control query sequence](../docs-site/docs/attack-statistical-anomaly-mapping.md#dns-c2) |
| [Autocorrelation Anomaly](#32-autocorrelation-anomaly) | [Repeated low-and-slow exfiltration](../docs-site/docs/attack-statistical-anomaly-mapping.md#low-and-slow-exfiltration), [periodic command-and-control communication](../docs-site/docs/attack-statistical-anomaly-mapping.md#periodic-c2) |
| [Synchronization Anomaly](#33-synchronization-anomaly) | [Compromised software produces synchronized endpoint changes](../docs-site/docs/attack-statistical-anomaly-mapping.md#supply-chain-installation), [synchronized service errors during disruption](../docs-site/docs/attack-statistical-anomaly-mapping.md#service-disruption) |
| [Distribution-Shift Anomaly](#34-distribution-shift-anomaly) | [DNS enumeration changes query distribution](../docs-site/docs/attack-statistical-anomaly-mapping.md#dns-enumeration), [obfuscated content changes character distribution](../docs-site/docs/attack-statistical-anomaly-mapping.md#obfuscated-content), [firewall policy shifts toward permissive rules](../docs-site/docs/attack-statistical-anomaly-mapping.md#firewall-impairment) |
| [Tail Anomaly](#41-tail-anomaly) | [Obfuscated content with extreme entropy](../docs-site/docs/attack-statistical-anomaly-mapping.md#obfuscated-content), [large outbound transfer](../docs-site/docs/attack-statistical-anomaly-mapping.md#large-outbound-transfer), [resource hijacking with extreme consumption](../docs-site/docs/attack-statistical-anomaly-mapping.md#resource-hijacking) |
| [Entropy Anomaly](#43-entropy-anomaly) | [Encoded or obfuscated content](../docs-site/docs/attack-statistical-anomaly-mapping.md#obfuscated-content), [DNS carrying encoded command-and-control data](../docs-site/docs/attack-statistical-anomaly-mapping.md#dns-c2) |
| [Multivariate Combination Anomaly](#48-multivariate-combination-anomaly) | [Phishing message with unusual combined features](../docs-site/docs/attack-statistical-anomaly-mapping.md#phishing-delivery), [valid-account use from an unexpected context](../docs-site/docs/attack-statistical-anomaly-mapping.md#valid-account-abuse), [privileged container with an unusual runtime profile](../docs-site/docs/attack-statistical-anomaly-mapping.md#privileged-container) |
| [Sequence-Order Anomaly](#60-sequence-order-anomaly) | [Delivered content followed by process execution](../docs-site/docs/attack-statistical-anomaly-mapping.md#phishing-execution-sequence), [PowerShell abuse sequence](../docs-site/docs/attack-statistical-anomaly-mapping.md#powershell-abuse), [lateral tool transfer followed by execution](../docs-site/docs/attack-statistical-anomaly-mapping.md#lateral-tool-transfer) |
| [Transition Anomaly](#61-transition-anomaly) | [Public request followed by an application child process](../docs-site/docs/attack-statistical-anomaly-mapping.md#public-app-exploitation), [process injection write-to-execution transition](../docs-site/docs/attack-statistical-anomaly-mapping.md#process-injection), [data collection followed by staging](../docs-site/docs/attack-statistical-anomaly-mapping.md#data-staging) |
| [Edge Anomaly](#69-edge-anomaly) | [First-seen sender-recipient relationship](../docs-site/docs/attack-statistical-anomaly-mapping.md#phishing-delivery), [new privilege relationship](../docs-site/docs/attack-statistical-anomaly-mapping.md#account-manipulation), [new lateral-administration path](../docs-site/docs/attack-statistical-anomaly-mapping.md#remote-service-lateral-movement), [new exfiltration destination](../docs-site/docs/attack-statistical-anomaly-mapping.md#web-service-exfiltration) |
| [Subgraph Anomaly](#70-subgraph-anomaly) | [Unusual process-injection relationship pattern](../docs-site/docs/attack-statistical-anomaly-mapping.md#process-injection) |
| [Graph-Path-Length Anomaly](#74-graph-path-length-anomaly) | [Unexpected path to privilege](../docs-site/docs/attack-statistical-anomaly-mapping.md#account-manipulation), [unusual lateral-administration path](../docs-site/docs/attack-statistical-anomaly-mapping.md#remote-service-lateral-movement) |
| [Graph-Evolution Anomaly](#75-graph-evolution-anomaly) | [Privilege graph abruptly restructures](../docs-site/docs/attack-statistical-anomaly-mapping.md#account-manipulation), [password spraying expands the authentication graph](../docs-site/docs/attack-statistical-anomaly-mapping.md#password-spraying), [internal scanning rapidly grows the communication graph](../docs-site/docs/attack-statistical-anomaly-mapping.md#internal-service-scanning) |
| [Fan-Out Anomaly](#78-fan-out-anomaly) | [External service scanning](../docs-site/docs/attack-statistical-anomaly-mapping.md#external-service-scanning), [password spraying](../docs-site/docs/attack-statistical-anomaly-mapping.md#password-spraying), [account enumeration](../docs-site/docs/attack-statistical-anomaly-mapping.md#account-enumeration), [lateral movement across many systems](../docs-site/docs/attack-statistical-anomaly-mapping.md#remote-service-lateral-movement) |
| [Rare-Category Anomaly](#84-rare-category-anomaly) | [Rare DNS query type during enumeration](../docs-site/docs/attack-statistical-anomaly-mapping.md#dns-enumeration), [rare command-interpreter argument pattern](../docs-site/docs/attack-statistical-anomaly-mapping.md#command-interpreter-execution), [unusual service-ticket encryption category](../docs-site/docs/attack-statistical-anomaly-mapping.md#kerberoasting) |
| [Novel-Category Anomaly](#85-novel-category-anomaly) | [First-seen PowerShell script feature](../docs-site/docs/attack-statistical-anomaly-mapping.md#powershell-abuse), [new system service](../docs-site/docs/attack-statistical-anomaly-mapping.md#service-persistence), [new forwarding destination](../docs-site/docs/attack-statistical-anomaly-mapping.md#mail-forwarding-rule) |
| [Category-Combination Anomaly](#86-category-combination-anomaly) | [Unexpected package-publisher combination](../docs-site/docs/attack-statistical-anomaly-mapping.md#supply-chain-installation), [trusted binary in an unusual execution context](../docs-site/docs/attack-statistical-anomaly-mapping.md#trusted-binary-proxy-execution), [unusual process-path archive creation](../docs-site/docs/attack-statistical-anomaly-mapping.md#data-staging) |
| [Categorical-Distribution Anomaly](#87-categorical-distribution-anomaly) | [Public web enumeration changes response-code composition](../docs-site/docs/attack-statistical-anomaly-mapping.md#public-web-enumeration), [cloud enumeration changes API action mix](../docs-site/docs/attack-statistical-anomaly-mapping.md#cloud-enumeration), [ransomware changes file-extension distribution](../docs-site/docs/attack-statistical-anomaly-mapping.md#ransomware-encryption) |
| [Cross-Source Inconsistency Anomaly](#91-cross-source-inconsistency-anomaly) | [Message or file activity followed by unexpected process execution](../docs-site/docs/attack-statistical-anomaly-mapping.md#phishing-execution-sequence) |
| [Missing-Correspondence Anomaly](#92-missing-correspondence-anomaly) | [Expected telemetry disappears after indicator removal](../docs-site/docs/attack-statistical-anomaly-mapping.md#indicator-removal), [sensor heartbeat disappears after tool disablement](../docs-site/docs/attack-statistical-anomaly-mapping.md#tool-disablement), [expected backup does not occur](../docs-site/docs/attack-statistical-anomaly-mapping.md#recovery-impairment) |
| [Persistent Anomaly](#111-persistent-anomaly) | [Repeated low-and-slow exfiltration](../docs-site/docs/attack-statistical-anomaly-mapping.md#low-and-slow-exfiltration), [persistent web-service command-and-control traffic](../docs-site/docs/attack-statistical-anomaly-mapping.md#web-service-c2) |
| [Emerging Anomaly](#113-emerging-anomaly) | [Resource hijacking produces an emerging consumption trend](../docs-site/docs/attack-statistical-anomaly-mapping.md#resource-hijacking) |
| [Cascading Anomaly](#114-cascading-anomaly) | [Ransomware encryption spreads across directories](../docs-site/docs/attack-statistical-anomaly-mapping.md#ransomware-encryption) |
